...
module.exports = {
    ...
    return ` 
      ...
      <body class="bg-light">
        <nav class="navbar navbar-expand-lg navbar-dark bg-success">
          <div class="container">
            <a class="navbar-brand mr-auto" href="/o" style="font-family:Arvo"><img src="icon/plant_image.png" style="width:2rem;heigth:2rem"> school plant</a>
        ...
        ${body}
        <!-- 관찰 올리기 버튼 -->
        <a href="javascript:showModal()" class="fixed-bottom ">
  ...
  create: function () {
    ...
    return `
      ...
      <script src="stylesheets/js/load-image.all.min.js"></script>
      <script>
        ${previewJS()}
