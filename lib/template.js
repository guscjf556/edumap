...
module.exports ={
            ...
            <div class="row row-cols-2 row-cols-lg-3">
              <div class="p-1">
                <div class="col text-center">
                  <input type="file" class="form-control-file d-none" id="o_image_1" name="o_image_1" accept="image/*" onchange="image1();" required>
                  <div class="m-1"><img id="imageResult1" src="#" alt="" class="img-fluid rounded-lg shadow-sm mx-auto d-block" style="min-height:90px;max-height:300px"></div>
                  <label for="o_image_1" class="btn btn-danger rounded-pill">➕전체</label>
                </div>
              </div>
              <div class="p-1">
                <div class="col text-center">
                  <input type="file" class="form-control-file d-none" id="o_image_2" name="o_image_2" accept="image/*" onchange="image2();">
                  <div class="m-1"><img id="imageResult2" src="#" alt="" class="img-fluid rounded-lg shadow-sm mx-auto d-block" style="min-height:90px;max-height:300px"></div>
                  <label for="o_image_2" class="btn btn-outline-success rounded-pill">➕잎</label>
                </div>
              </div>
              <div class="p-1">
                <div class="col text-center">
                  <input type="file" class="form-control-file d-none" id="o_image_3" name="o_image_3" accept="image/*" onchange="image3();">
                  <div class="m-1"><img id="imageResult3" src="#" alt="" class="img-fluid rounded-lg shadow-sm mx-auto d-block" style="min-height:90px;max-height:300px"></div>
                  <label for="o_image_3" class="btn btn-outline-success rounded-pill">➕꽃</label>
                </div>
              </div>
              <div class="p-1">
                <div class="col text-center">
                  <input type="file" class="form-control-file d-none" id="o_image_4" name="o_image_4" accept="image/*" onchange="image4();">
                  <div class="m-1"><img id="imageResult4" src="#" alt="" class="img-fluid rounded-lg shadow-sm mx-auto d-block" style="min-height:90px;max-height:300px"></div>
                  <label for="o_image_4" class="btn btn-outline-success rounded-pill">➕줄기</label>
                </div>
              </div>
              <div class="p-1">
                <div class="col text-center">
                  <input type="file" class="form-control-file d-none" id="o_image_5" name="o_image_5" accept="image/*" onchange="image5();">
                  <div class="m-1"><img id="imageResult5" src="#" alt="" class="img-fluid rounded-lg shadow-sm mx-auto d-block" style="min-height:90px;max-height:300px"></div>
                  <label for="o_image_5" class="btn btn-outline-success rounded-pill">➕열매</label>
                </div>
              </div>
            </div>
          </div>
    ...
    <script>
      ...
      function image1(){
        var image = document.querySelector('#o_image_1');
        var reader = new FileReader();
        var imageContainer = document.getElementById('imageResult1')
      ...
      function image2(){
          var image = document.querySelector('#o_image_2');
          var reader = new FileReader();
          var imageContainer = document.getElementById('imageResult2')
          reader.onload = function(e) {
            imageContainer.src = e.target.result;
          }
          reader.readAsDataURL(image.files[0]);
      ...
      function image3(){
        var image = document.querySelector('#o_image_3');
        var reader = new FileReader();
        var imageContainer = document.getElementById('imageResult3')
        reader.onload = function(e) {
          imageContainer.src = e.target.result;
        }
        reader.readAsDataURL(image.files[0]);
      ...
      function image4(){
        var image = document.querySelector('#o_image_4');
        var reader = new FileReader();
        var imageContainer = document.getElementById('imageResult4')
        reader.onload = function(e) {
          imageContainer.src = e.target.result;
        }
        reader.readAsDataURL(image.files[0]);
      ...
      function image5(){
        var image = document.querySelector('#o_image_5');
        var reader = new FileReader();
        var imageContainer = document.getElementById('imageResult5')
        reader.onload = function(e) {
          imageContainer.src = e.target.result;
        }
        reader.readAsDataURL(image.files[0]);
