      ...
      function imageFormMaker(){
        ...
        <div>
            <div class="col text-center">
              ...
              <label for="o_image_${1}"><img id="imageResult${1}" src="/data/photoUpload.png" alt="" class="img-fluid img-thumbnail d-block" style="min-width:150px;height:150px;">${categories[0]}</label>
            </div>
          </div>
        `
        for(var i = 2; i < 6; i++){
          ...
          <div>
            <div class="col text-center">
              ...
              <label for="o_image_${i}"><img id="imageResult${i}" src="/data/photoUpload.png" alt="" class="img-fluid img-thumbnail d-block" style="min-width:150px;height:150px;">${categories[i-1]}</label>
            </div>
          </div>
          `
        }
