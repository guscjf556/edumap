    ...
    if(this.IsOwner(req, res)){
      authStatusUI = `
        ...
        <li class="nav-item dropdown">
          ...
          <div id="navbarProjectList" class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <div id="${req.user.userID}"></div>
          </div>
        </li>
        <li class="nav-item" >
          <a class="nav-link text-secondary" href="/u/logout">로그아웃</a>
        </li>`
      return authStatusUI
    };
  },
